...
export function AlignmentSection({ alignment, verticalAlignment, onChange }: AlignmentSectionProps) {
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-sm font-medium text-text-primary">{t('对齐')}</h3>

      <div className="flex gap-2">
        {/* 左对齐 */}
        <button
          onClick={() => handleAlignmentClick('left')}
          className={`flex-1 h-9 rounded-lg border transition-all flex items-center justify-center ${alignment === 'left'
        ...
        <button
          ...
          className={`flex-1 h-9 rounded-lg border transition-all flex items-center justify-center ${alignment === 'center' && verticalAlignment === 'center'
            ? 'bg-accent-purple border-accent-purple text-white shadow-lg shadow-accent-purple/20'
            : 'bg-bg-tertiary border-border-secondary text-text-secondary hover:border-border-primary'
            }`}
          title={t('居中对齐')}
        ...
        <button
          ...
          className={`flex-1 h-9 rounded-lg border transition-all flex items-center justify-center ${alignment === 'right'
            ? 'bg-accent-purple border-accent-purple text-white shadow-lg shadow-accent-purple/20'
            : 'bg-bg-tertiary border-border-secondary text-text-secondary hover:border-border-primary'
            }`}
          title={t('右对齐')}
        ...
        <button
          ...
          className={`flex-1 h-9 rounded-lg border transition-all flex items-center justify-center ${verticalAlignment === 'top'
            ? 'bg-accent-purple border-accent-purple text-white shadow-lg shadow-accent-purple/20'
            : 'bg-bg-tertiary border-border-secondary text-text-secondary hover:border-border-primary'
            }`}
          title={t('上对齐')}
        ...
        <button
          ...
          className={`flex-1 h-9 rounded-lg border transition-all flex items-center justify-center ${verticalAlignment === 'bottom'
            ? 'bg-accent-purple border-accent-purple text-white shadow-lg shadow-accent-purple/20'
            : 'bg-bg-tertiary border-border-secondary text-text-secondary hover:border-border-primary'
            }`}
          title={t('下对齐')}
