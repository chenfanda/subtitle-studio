...
export function GifCard({ gif, currentSubtitle }: GifCardProps) {
  ...
  }, [currentSubtitle, placedMedia, gif.url]);

  const handleApply = (e: React.MouseEvent) => {
    e.stopPropagation();
    
    if (!hasThisMedia && currentSubtitle) {
      placeOnTimeline(gif, currentSubtitle.startTime, currentSubtitle.endTime);
      setIsApplied(true);
